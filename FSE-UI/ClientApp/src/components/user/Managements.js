...
import { USER_SERVICE_URL } from '../utilities';
export class Managements extends Component {
    static displayName = Managements.name;
    state = {
        userId: '',
        employeeId: '',
        firstName: '',
    ...
    getUsers = () => {
        fetch(`${USER_SERVICE_URL}/GetAllEmployee`)
            .then(res => {
                console.log("***********************");
    ...
    delUser = userId => {
        ...
        if (confirmClose) {
            fetch(`${USER_SERVICE_URL}?empId=${userId}`, {
                method: 'delete',
            })
                .then(res => {
                    console.log("******************");
    ...
    searchUser = e => {
        ...
        fetch(`${USER_SERVICE_URL}/SearchUser?${searchParam.toString()}`)
            .then(res => {
                console.log("***********************");
                console.log(res.status)
                console.log("***********************");
